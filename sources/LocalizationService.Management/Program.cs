...
builder.Services.AddScoped<IPublishChangesHandler, PublishChangesHandler>();
builder.Services.AddScoped<IAddLocalizationKeyHandler, AddLocalizationKeyHandler>();
builder.Services.AddScoped<IUpdateLocalizationKeyTranslationHandler, UpdateLocalizationKeyTranslationHandler>();
builder.Services.AddScoped<IRemoveLocalizationKeyHandler, RemoveLocalizationKeyHandler>();
builder.Services.AddScoped<IRemoveAllKeyTranslationsHandler, RemoveAllKeyTranslationsHandler>();
